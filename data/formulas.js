...
const FORMULAS_DATA = [
  ...
  },
  {
    ...
    "example": "Gửi tiền tiết kiệm với lãi suất danh nghĩa $i = 8\\%/năm$, tỷ lệ lạm phát kỳ vọng là $1$ = 3\\%/năm$: lãi suất thực tế người gửi nhận được xấp xỉ $r = 8\\% - 3\\% = 5\\%/năm$.",
  ...
  },
  {
    ...
    "example": "Nếu cung tiền $M$ tăng trưởng 10%/năm, sản lượng thực tế $Y$ tăng 3%/năm, tốc độ vòng quay tiền tệ $V$ ổn định không đổi: tỷ lệ lạm phát dài hạn sẽ là $1$ = \\%\\Delta P = 10\\% - 3\\% = 7\\%/năm$.",
