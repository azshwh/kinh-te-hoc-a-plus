...
const TRAPS_DATA = [
  ...
  },
  {
    ...
    title: "Tác động lấn át đầu tư (Crowding-out Effect) của chính sách tài khóa",
    severity: "Cao",
  ...
  },
  {
    ...
    title: "Quan hệ giữa tiết kiệm quốc dân (S), đầu tư nội địa (I) và xuất khẩu ròng (NX)",
    severity: "Cao",
  ...
  },
  {
    ...
    title: "Phân biệt hàng hóa thông thường, hàng hóa thứ cấp và hàng xa xỉ",
    severity: "Trung bình",
