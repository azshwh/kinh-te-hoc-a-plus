...
const TRUE_FALSE_DATA = [
  ...
  },
  {
    ...
    graphTip: "Vẽ đồ thị cân bằng dài hạn của cạnh tranh hoàn hảo tại $P = ATC_{\\min}$, ở đó $\$\pi$_{kinh\\,tế} = 0$.",
  ...
  },
  {
    ...
    category: "micro",
    chapter: 4,
    topic: "Nghịch lý Hàng hóa Giffen & Slutsky",
    statement: "Hàng hóa Giffen là một loại hàng hóa cấp thấp đặc biệt có đường cầu dốc lên, vì Hiệu ứng thu nhập (IE) mang dấu dương và có độ lớn áp đảo hoàn toàn Hiệu ứng thay thế (SE).",
    verdict: "ĐÚNG",
    explanation: "Đối với mọi hàng hóa thông thường và cấp thấp, Hiệu ứng thay thế (SE) luôn nghịch biến với giá ($P \\uparrow \\implies Q \\downarrow$). Tuy nhiên, đối với hàng hóa Giffen (loại hàng cấp thấp cực đoan chiếm tỷ trọng lớn trong ngân sách người nghèo), khi giá tăng làm sức mua sụt giảm nghiêm trọng, Hiệu ứng thu nhập (IE) kích thích người nghèo phải mua nhiều loại hàng giá rẻ này hơn nữa ($P \\uparrow \\implies Q \\uparrow$). Vì $|IE| > |SE|$, tổng tác động khiến lượng cầu tăng khi giá tăng, tạo ra nghịch lý đường cầu dốc lên vi phạm quy luật cầu thông thường.",
    academicFormula: "\\Delta Q_{tổng} = \\underbrace{SE}_{< 0} + \\underbrace{IE}_{> 0}. \\quad \\text{Giffen } \\iff |IE| > |SE| \\implies \\frac{\\Delta Q}{\\Delta P} > 0",
    graphTip: "Vẽ đường cầu dốc lên về bên phải và phân rã 3 điểm A, B, C theo Slutsky trên đồ thị đường bàng quan.",
    examTip: "Điều kiện đủ để là hàng Giffen: phải là hàng cấp thấp VÀ Hiệu ứng thu nhập phải thắng Hiệu ứng thay thế."
  },
  {
    id: "tf30",
    category: "micro",
    chapter: 4,
    topic: "Hàm thỏa dụng & Nghiệm góc",
    statement: "Người tiêu dùng luôn lựa chọn giỏ hàng tối ưu tại tiếp điểm giữa đường bàng quan và đường ngân sách, nơi có MRS = P_X / P_Y.",
    verdict: "SAI",
    explanation: "Điều kiện tiếp xúc $MRS = P_X/P_Y$ chỉ ĐÚNG khi đường bàng quan cong lồi về gốc tọa độ (hàm trơn như Cobb-Douglas) và có nghiệm trong (Interior solution). Trong trường hợp hai hàng hóa thay thế hoàn hảo ($U = aX + bY$), đường bàng quan là đường thẳng, nếu độ dốc đường bàng quan khác đường ngân sách ($MRS \\ne P_X/P_Y$), người tiêu dùng sẽ chọn nghiệm góc (Corner Solution) bằng cách dồn 100% ngân sách chỉ mua một loại hàng hóa duy nhất. Hoặc với hàng bổ sung hoàn hảo (hàm Leontief), đường bàng quan hình chữ L không có đạo hàm tại đỉnh góc nhọn.",
    academicFormula: "U = aX + bY: \\quad MRS = \\frac{a}{b} > \\frac{P_X}{P_Y} \\implies X^* = \\frac{I}{P_X}, Y^* = 0 \\quad (\\text{Nghiệm góc})",
    graphTip: "Vẽ đường ngân sách cắt trục tung/trục hoành và đường bàng quan thẳng dốc hơn đường ngân sách.",
    examTip: "Bẫy điểm 10: Nhớ xét trường hợp nghiệm góc khi gặp hàm thay thế hoàn hảo hoặc hàm tuyến tính."
  },
  {
    id: "tf31",
    category: "micro",
    chapter: 5,
    topic: "Sản xuất dài hạn & MRTS",
    statement: "Độ dốc của đường đồng lượng (Isoquant) phản ánh Tỷ lệ thay thế kỹ thuật biên (MRTS) và luôn bằng tỷ số giữa Năng suất cận biên của lao động và vốn (MP_L / MP_K).",
    verdict: "ĐÚNG",
    explanation: "Đường đồng lượng thể hiện tất cả các tập hợp kết hợp giữa Lao động ($L$) và Vốn ($K$) tạo ra cùng một mức sản lượng $Q_0$. Lấy vi phân toàn phần $dQ = MP_L \\cdot dL + MP_K \\cdot dK = 0 \\implies -\\frac{dK}{dL} = \\frac{MP_L}{MP_K} = MRTS_{LK}$. Tỷ lệ này đo lường lượng vốn có thể giảm bớt khi sử dụng thêm 1 đơn vị lao động mà sản lượng không đổi. Quy luật năng suất cận biên giảm dần khiến đường đồng lượng cong lồi về gốc tọa độ và $MRTS_{LK}$ giảm dần dọc theo đường đồng lượng.",
    academicFormula: "MRTS_{LK} = -\\frac{dK}{dL}\\Big|_{Q=Q_0} = \\frac{MP_L}{MP_K}",
    graphTip: "Vẽ họ đường đồng lượng cong lồi hướng ra xa gốc tọa độ biểu diễn các mức sản lượng cao hơn.",
    examTip: "Điểm tối ưu chi phí trong dài hạn xảy ra khi đường đồng lượng tiếp xúc với đường đồng phí: $MRTS_{LK} = w / r$."
  },
  {
    id: "tf32",
    category: "micro",
    ...
    statement: "Trong mô hình độc quyền nhóm Cournot, khi số lượng doanh nghiệp tham gia thị trường (N) tiến tới vô cùng, mức giá và sản lượng của ngành sẽ tiến dần tới trạng thái Cạnh tranh hoàn hảo.",
    verdict: "ĐÚNG",
    explanation: "Trong mô hình Cournot với $N$ doanh nghiệp đồng nhất có chi phí biên $MC$: Tổng sản lượng ngành là $Q = \\frac{N}{N + 1} Q_C$ và Chỉ số sức mạnh thị trường Lerner là $L = \\frac{P - MC}{P} = \\frac{1}{N \\cdot |E_D|}$. Khi số lượng doanh nghiệp tăng lên ($N \\to \\infty$), thị phần của mỗi doanh nghiệp teo nhỏ lại, sức mạnh độc quyền tiệm cận về 0 ($L \\to 0$), giá thị trường giảm dần về chi phí biên ($P \\to MC$) và tổng sản lượng tiến tới mức sản lượng cạnh tranh hoàn hảo ($Q \\to Q_C$).",
    academicFormula: "\\lim_{N \\to \\infty} \\frac{P - MC}{P} = \\lim_{N \\to \\infty} \\frac{1}{N |E_D|} = 0 \\implies P = MC \\quad (\\text{Cạnh tranh hoàn hảo})",
    graphTip: "Vẽ đường biểu diễn giá P giảm dần theo N từ mức giá độc quyền $P_M$ (N=1) xuống mức cạnh tranh $P_C$ (N vô cùng).",
    examTip: "Cournot là cầu nối lý thuyết bắc giữa Độc quyền thuần túy (N=1) và Cạnh tranh hoàn hảo (N vô hạn)."
  },
  {
    id: "tf33",
    category: "micro",
    ...
    statement: "Hiện tượng Lựa chọn bất lợi (Adverse Selection) xảy ra sau khi hợp đồng được ký kết, khi một bên thay đổi hành vi theo hướng bất cẩn hơn vì không phải gánh chịu toàn bộ rủi ro.",
    verdict: "SAI",
    explanation: "Đây là định nghĩa của nguy cơ đạo đức (Moral Hazard), không phải Lựa chọn bất lợi. Lựa chọn bất lợi (Adverse Selection - mô hình Market for Lemons của Akerlof) xảy ra trước khi giao dịch ký kết hợp đồng, do một bên nắm giữ thông tin ẩn về chất lượng hàng hóa (người bán xe cũ biết xe tốt hay hỏng hóc). Ngược lại, Rủi ro đạo đức (Moral Hazard) xảy ra sau khi ký hợp đồng do hành vi ẩn (mua bảo hiểm xe xong thì lái xe ẩu hơn vì bảo hiểm đền bù).",
    academicFormula: "\\text{Trước hợp đồng: Thông tin ẩn } \\implies \\text{Lựa chọn bất lợi; } \\quad \\text{Sau hợp đồng: Hành vi ẩn } \\implies \\text{Rủi ro đạo đức}",
    graphTip: "Vẽ sơ đồ phân loại thông tin bất đối xứng thành 2 nhánh: Trước ký kết (Adverse selection) vs Sau ký kết (Moral hazard).",
    examTip: "Bẫy trắc nghiệm kinh điển: Luôn nhớ 'Trước hợp đồng = Lựa chọn bất lợi' và 'Sau hợp đồng = Rủi ro đạo đức'."
  },
  {
    id: "tf34",
    category: "micro",
    chapter: 7,
    topic: "Thị trường lao động & Giá trị sản phẩm biên",
  ...
  },
  {
    ...
    category: "macro",
    chapter: 8,
    topic: "Mô hình Solow & Quy tắc vàng",
  ...
  },
  {
    ...
    category: "macro",
    chapter: 12,
    topic: "Mô hình Mundell - Fleming & Tỷ giá",
    statement: "Trong mô hình Mundell-Fleming với vốn luân chuyển tự do hoàn hảo, dưới chế độ tỷ giá thả nổi, chính sách tài khóa mở rộng có hiệu lực kích thích sản lượng cực kỳ mạnh mẽ.",
    verdict: "SAI",
    explanation: "Dưới chế độ tỷ giá thả nổi, chính sách tài khóa mở rộng (tăng $G$ hoặc giảm $T$) hoàn toàn vô hiệu trong việc làm tăng sản lượng. Cơ chế: Khi $G$ tăng làm tăng cầu tiền, gây áp lực tăng lãi suất trong nước ($r > r^*$). Dòng vốn quốc tế ồ ạt chảy vào mua trái phiếu nội địa làm ĐỒNG NỘI TỆ tăng giá MẠNH ($e \\uparrow$). Đồng nội tệ tăng giá bóp nghẹt ngành xuất khẩu và kích thích nhập khẩu, làm Xuất khẩu ròng sụt giảm ($\Delta NX < 0$) đúng bằng lượng tăng ban đầu của $G$. Sản lượng $Y$ không đổi, đường $LM^*$ thẳng đứng cố định sản lượng. Ngược lại, chính sách TIỀN TỆ mới là công cụ có hiệu lực tối đa dưới tỷ giá thả nổi.",
    academicFormula: "G \\uparrow \\implies e \\uparrow \\implies NX \\downarrow \\implies \\Delta Y = 0 \\quad (\\text{Tài khóa vô hiệu dưới tỷ giá thả nổi})",
    graphTip: "Vẽ hệ trục (e, Y): Đường LM* thẳng đứng, IS* dịch phải chỉ làm tỷ giá e tăng từ $e_1 \\to e_2$, sản lượng Y giữ nguyên.",
    examTip: "Ghi nhớ ma trận Mundell-Fleming: Tài khóa hiệu quả dưới tỷ giá cố định; Tiền tệ hiệu quả dưới tỷ giá thả nổi."
  },
  {
    id: "tf37",
    category: "macro",
    chapter: 12,
    topic: "Bộ ba bất khả thi (Trilemma)",
    statement: "Một nền kinh tế mở hội nhập sâu rộng có thể đồng thời duy trì: (1) Tỷ giá cố định, (2) Dòng vốn tự do luân chuyển và (3) Chính sách tiền tệ độc lập.",
    verdict: "SAI",
    explanation: "Theo Định lý 'Bộ ba bất khả thi' (The Impossible Trinity / Trilemma) của Robert Mundell (Nobel 1999) và Marcus Fleming, một quốc gia chỉ có thể chọn tối đa 2 TRONG 3 mục tiêu trên, không bao giờ có thể đạt được cả 3 đồng thời. Ví dụ: Nếu mở cửa dòng vốn tự do (2) và muốn hạ lãi suất để kích thích kinh tế (3 độc lập), dòng vốn sẽ tháo chạy ra nước ngoài để tìm lãi suất cao hơn, gây áp lực bán tháo nội tệ làm sụp đổ tỷ giá cố định (1). Muốn giữ tỷ giá cố định, NHTW buộc phải bán ngoại tệ dự trữ và tăng lãi suất trở lại, làm mất tính độc lập tiền tệ.",
    academicFormula: "\\text{Trilemma: Chọn 2 trong 3 } \\{ \\text{Tỷ giá cố định, Dòng vốn tự do, Tiền tệ độc lập} \\}",
    graphTip: "Vẽ hình tam giác Trilemma với 3 đỉnh là 3 mục tiêu, mỗi cạnh là một chế độ chính sách (ví dụ: Khu vực Eurozone, Mỹ, Trung Quốc).",
    examTip: "Khủng hoảng tài chính Châu Á 1997 nổ ra chính do Thái Lan và các nước Đông Nam Á cố duy trì cả 3 đỉnh tam giác này."
  },
  {
    id: "tf38",
    category: "macro",
    ...
    statement: "Theo học thuyết Tương đương Ricardo, việc chính phủ giảm thuế hôm nay và tài trợ thâm hụt bằng cách phát hành trái phiếu sẽ không làm tăng tiêu dùng của hộ gia đình.",
    verdict: "ĐÚNG",
    explanation: "Nhà kinh tế Robert Barro phát triển học thuyết Tương đương Ricardo (Ricardian Equivalence) dựa trên hành vi người tiêu dùng nhìn về tương lai (Forward-looking). Khi chính phủ cắt giảm thuế 1.000 USD hôm nay và vay nợ, người dân hiểu rằng số nợ công và tiền lãi tích lũy này bắt buộc sẽ phải được trả bằng một đợt tăng thuế tương đương trong tương lai. Do đó, thu nhập khả dụng cả đời của họ không hề tăng lên. Thay vì đem 1.000 USD đi tiêu dùng ($C$), họ sẽ đem toàn bộ số tiền đó gửi tiết kiệm ($S$) để dành đóng thuế tương lai. Kết quả: Tổng cầu ($AD$) không hề dịch chuyển và chính sách giảm thuế bị triệt tiêu hiệu quả.",
    academicFormula: "\\Delta T < 0 \\implies \\Delta S_{tư\\,nhân} = -\\Delta T \\implies \\Delta C = 0 \\implies \\Delta AD = 0",
    graphTip: "Vẽ đường ngân sách liên thời kỳ của hộ gia đình không đổi khi chính phủ hoãn thuế.",
    examTip: "Tương đương Ricardo là lập luận chủ chốt của các nhà kinh tế học trường phái cổ điển mới phản biện chính sách kích cầu tài khóa Keynes."
  },
  {
    id: "tf39",
    category: "macro",
    chapter: 11,
    topic: "Quy tắc Taylor & Nguyên lý Taylor",
  ...
  },
  {
    ...
    category: "macro",
    chapter: 10,
    topic: "Cú sốc cung & Hiện tượng Đình lạm",
    statement: "Một cú sốc cung bất lợi (như giá dầu mỏ toàn cầu tăng vọt) làm dịch chuyển đường Tổng cung ngắn hạn (SRAS) sang trái, gây ra hiện tượng Đình lạm (Stagflation) khiến sản lượng giảm và mức giá tăng đồng thời.",
    verdict: "ĐÚNG",
    explanation: "Khi giá dầu mỏ hoặc nguyên liệu đầu vào tăng sốc, chi phí sản xuất của mọi doanh nghiệp trong nền kinh tế tăng vọt. Tại mỗi mức giá đầu ra, các doanh nghiệp buộc phải cắt giảm sản xuất, làm đường Tổng cung ngắn hạn ($SRAS$) dịch chuyển sang trái. Điểm cân bằng vĩ mô ngắn hạn mới di chuyển dọc theo đường Tổng cầu ($AD$): Sản lượng thực tế sụt giảm dưới mức tiềm năng ($Y_1 < Y_p$), tỷ lệ thất nghiệp tăng cao, trong khi mức giá chung của nền kinh tế lại bị đẩy lên cao ($P_1 > P_0$). Sự kết hợp tồi tệ giữa Đình trệ kinh tế (Stagnation) và Lạm phát (Inflation) được gọi là đình lạm (Stagflation), là bài toán hóc búa nhất vì dùng chính sách kích cầu sẽ làm tăng thêm lạm phát, còn thắt chặt tiền tệ sẽ làm tăng thêm thất nghiệp.",
    academicFormula: "\\text{Cú sốc cung bất lợi: } SRAS \\text{ dịch trái} \\implies Y \\downarrow \\text{ (Thất nghiệp } \\uparrow\\text{)} \\quad \\text{và} \\quad P \\uparrow \\text{ (Lạm phát } \\uparrow\\text{)}",
    graphTip: "Vẽ mô hình AD-AS: SRAS dịch trái từ $SRAS_0 \\to SRAS_1$, giao điểm mới có giá cao hơn và sản lượng thấp hơn.",
    examTip: "Khủng hoảng dầu mỏ 1973 OPEC là minh chứng lịch sử điển hình cho hiện tượng Đình lạm."
  }
];
