// Script biên soạn toàn diện 12 Chương Lý thuyết Kinh tế học đại cương chuẩn Mankiw & Varian
const fs = require('fs');
    ...
    sections: [
      ...
      },
      {
        ...
        content: `
          ...
          <div class="p-3 bg-amber-50 dark:bg-slate-800 rounded-xl border border-amber-200 dark:border-slate-700 text-xs font-mono space-y-1">
...
const output = `// Cơ sở dữ liệu Lý thuyết Chuyên sâu 12 Chương môn Kinh tế học đại cương
// Biên soạn chuẩn mực theo giáo trình N. Gregory Mankiw, Paul Samuelson và Hal Varian
const THEORY_DATA = ${JSON.stringify(THEORY_DATA, null, 2)};
...
fs.writeFileSync(path.join(__dirname, 'data', 'theory.js'), output, 'utf8');
console.log("✓ Đã biên soạn hoàn chỉnh 12 chương lý thuyết chuẩn Mankiw vào data/theory.js!");
